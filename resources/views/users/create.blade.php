        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white">
                    <h2 class="text-2xl font-semibold text-teal-700 mb-6">{{ __('Buat Pengguna Baru') }}</h2>
                    
                    <form action="{{ route('users.store') }}" method="POST" id="createUserForm">
                        @csrf
                        <div class="mb-4">
                            <label for="name" class="block text-sm font-medium text-teal-700">Nama</label>
                            <input type="text" name="name" id="name" class="mt-1 focus:ring-teal-500 focus:border-teal-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required autofocus>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <label for="password" class="block text-sm font-medium text-teal-700">Kata Sandi (minimal 8 karakter)</label>
                            <input type="password" name="password" id="password" class="mt-1 focus:ring-teal-500 focus:border-teal-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required minlength="8">
                        </div>
                        <div class="mb-4">
                            <label for="password_confirmation" class="block text-sm font-medium text-teal-700">Konfirmasi Kata Sandi</label>
                            <input type="password" name="password_confirmation" id="password_confirmation" class="mt-1 focus:ring-teal-500 focus:border-teal-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required minlength="8">
                        </div>
                        <div class="mb-4">
